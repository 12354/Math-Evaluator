...
namespace Qfi
{
    public class Interpreter
    {
        ...
        public Interpreter()
        {
            ...
            //add new check_pos function
            Functions["check_pos"] = new ExternFunction(new FunctionPrototype("check_pos", new List<string>() { "x", "y" }), (x, y) => { Console.SetCursorPosition((int)x, (int)y); return 0; });
